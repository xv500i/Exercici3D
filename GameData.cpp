...
bool GameData::loadTextures()
{
	const char* filenames[NUM_TEXTURES] = {"title", "instructions", "pause", "gameover", "button_quit", "button_start", 
										   ...
										   "EnergyParticleMask1", "EnergyParticleMask2", "EnergyParticleMask3", "EnergyParticleMask4"};
...
bool GameData::loadSounds()
{
	const char* filenames[NUM_SOUNDS] = {"Jungle_Theme", "Boss_Battle", "Title_Theme", "Game_Over", "gun", "flamer", 
										 ...
										 "explosion", "clank", "Snow_Field"};
	const bool loop[NUM_SOUNDS] = {true, true, false, false, false, false, false, false, false, false, false, false, false, false, true};
	const float volumes[NUM_SOUNDS] = {1.0f, 1.0f, 1.0f, 1.0f, 0.3f, 0.8f, 1.0f, 1.0f, 0.8f, 1.5f, 1.0f, 1.0f, 2.8f, 1.4f, 1.0f};
